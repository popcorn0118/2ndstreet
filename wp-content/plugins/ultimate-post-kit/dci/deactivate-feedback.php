...
if ( ! function_exists( 'dci_deactivate_feedback' ) ) {
	function dci_deactivate_feedback( $data ) {
		...
		<div class="dci-feedback-wrapper" id="<?php echo esc_attr( $plugin_deactivate_id ); ?>" style="display:none;">
			<div class="dci-feedback-card">
				<h2><?php esc_html_e( 'Give feedback', 'ultimate-post-kit' ); ?></h2>
				<p><?php esc_html_e( 'Goodbyes are never easy. If you have a moment, please share your feedback on how we can improve.', 'ultimate-post-kit' ); ?>
				</p>
							...
							<div class="checkbox">
								<label class="checkbox-wrapper">
									...
									<span class="checkbox-tile">
										...
										<span
											class="checkbox-label"><?php esc_html_e( 'Switching Domain', 'ultimate-post-kit' ); ?></span>
									</span>
								</label>
							</div>
							<div class="checkbox">
								<label class="checkbox-wrapper">
									...
									<span class="checkbox-tile">
										...
										<span
											class="checkbox-label"><?php esc_html_e( 'Couldn\'t understand', 'ultimate-post-kit' ); ?></span>
									</span>
								</label>
							</div>
							<div class="checkbox">
		...
		c12.322-12.327,12.322-32.307-0.005-44.634L1579.829,1125.662z" />
										...
										<span
											class="checkbox-label"><?php esc_html_e( 'Found a better plugin', 'ultimate-post-kit' ); ?></span>
									</span>
								</label>
							</div>
							<div class="checkbox">
	...
	C499.5,480.7,531.3,438.3,499.5,385.4z M298.4,438.3h-84.7v-84.7h84.7V438.3z M298.4,311.3h-84.7V120.7h84.7V311.3z" />
										...
										<span
											class="checkbox-label"><?php esc_html_e( 'Missing a specific feature', 'ultimate-post-kit' ); ?></span>
									</span>
								</label>
							</div>
							<div class="checkbox">
		...
		C442.303,271.102,426.367,287.057,406.663,287.057z" />
										...
										<span
											class="checkbox-label"><?php esc_html_e( 'Not working', 'ultimate-post-kit' ); ?></span>
									</span>
								</label>
							</div>
							<div class="checkbox">
								<label class="checkbox-wrapper">
									...
									<span class="checkbox-tile">
										...
										<span
											class="checkbox-label"><?php esc_html_e( 'Others', 'ultimate-post-kit' ); ?></span>
									</span>
								</label>
							</div>
						</div>
					...
					<div class="dci-feedback-comments">
						<label>
							<?php esc_html_e( 'What is the main reason for deactivating?', 'ultimate-post-kit' ); ?>
						</label>
					...
					<div class="dci-feedback-actions">
						<a class="button" href="<?php echo esc_url( $deactivate_url ); ?>">
							<?php esc_html_e( 'Skip & Deactivate', 'ultimate-post-kit' ); ?>
						</a>
						<div>
							<a class="button" href="<?php echo esc_url( $plugin_page_url ); ?>">
								<?php esc_html_e( 'Cancel', 'ultimate-post-kit' ); ?>
							</a>
							<button name="dci_status_sub_and_dea" value="skip" type="button"
								...
								<?php esc_html_e( 'Submit & Deactivate', 'ultimate-post-kit' ); ?>
							</button>
						</div>
					</div>
				</form>
